						...
						<div class="specialties">
							<ul>
								<li class="orange">
									<a href="#">
										<h2>Janitorial</h2>
										<img src="<?php print $base_path . $directory ?>/images/home-slider-filler.jpg" alt="home-slider-filler" width="128" height="120" />
									</a>
								</li>
								<li class="blue">
									<a href="#">
										<h2>Painting</h2>
										<img src="<?php print $base_path . $directory ?>/images/home/painting.jpg" alt="home-slider-filler" width="128" height="120" />
									</a>
								</li>
								<li class="green">
									<a href="#">
										<h2>Landscape design</h2>
										<img src="<?php print $base_path . $directory ?>/images/home/landscaping.jpg" alt="home-slider-filler" width="128" height="120" />
									</a>
								</li>
								<li class="purple">
									<a href="#">
										<h2>Pest control</h2>
										<img src="<?php print $base_path . $directory ?>/images/home/pest-control.jpg" alt="home-slider-filler" width="128" height="120" />
									</a>
								</li>
								<li class="orange">
									<a href="#">
										<h2>HVAC</h2>
										<img src="<?php print $base_path . $directory ?>/images/home/hvac.jpg" alt="home-slider-filler" width="128" height="120" />
									</a>
								</li>
								<li class="blue">
									<a href="#">
										<h2>Roofing</h2>
										<img src="<?php print $base_path . $directory ?>/images/home/roofing.jpg" alt="home-slider-filler" width="128" height="120" />
									</a>
								</li>
								<li class="green">
									<a href="#">
										<h2>Plumbing</h2>
										<img src="<?php print $base_path . $directory ?>/images/home/plumbing.jpg" alt="home-slider-filler" width="128" height="120" />
									</a>
								</li>
								<li class="purple">
									<a href="#">
										<h2>Lighting</h2>
										<img src="<?php print $base_path . $directory ?>/images/home/lighting.jpg" alt="home-slider-filler" width="128" height="120" />
									</a>
								</li>
