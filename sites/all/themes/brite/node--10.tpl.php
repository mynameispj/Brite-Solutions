...
$headerImage = field_get_items('node',$node,'field_header_image');
...
<div class="title">
	<div class="wrap contact">
	    ...
	    <div id="address" style="display:none;">8134 Country Village Drive  Cordova, TN 38016</div>
		<script type="text/javascript">
			...
			var geocoder;
	     	function initialize() {
				...
				var myLatlng = new google.maps.LatLng(35.165617,-89.790874); 
